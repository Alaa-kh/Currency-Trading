...
class DrawerLoginWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<LogoutControllerImpl>(
        builder: (controller) =>
            Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  itemBuilder: (context, index) => ListTile(
                      onTap: () {
                        signalsDrawerLoginModel[index].text == 'Login'
                            ...
                            : signalsDrawerLoginModel[index].text ==
                                    'Notifications'
              ...
              Container(
                  ...
                  decoration: BoxDecoration(
                      ...
                      border:
                          Border.all(color: const Color(0xffF2B80C), width: 2)),
                  child: Row(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        Image.asset(IconsAssets.copyIcon,
                            width: 12, height: 14),
